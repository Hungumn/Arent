			...
			<Box mt={10} px={3}>
				...
				>
					{categories.map((category) => (
						...
						>
							<Typography sx={{ color: '#FFCC21', fontSize: '22px' }}>{category.title.split(' ')[0]}</Typography>
							<Typography sx={{ color: '#FFCC21', fontSize: '22px' }}>{category.title.split(' ')[1]}</Typography>
							<Box
								sx={{
							...
							/>
							<Typography sx={{ color: '#fff', fontSize: '18px' }}>{category.text}</Typography>
						</Box>
					))}
				</Box>
				...
				>
					{columnsData.map((column) => (
						<Box key={column.title}>
							...
							<Typography sx={{ fontSize: '15px', my: 1 }}>{column.title}</Typography>
							<Typography sx={{ fontSize: '12px', color: '#FF963C' }}>{column.tags}</Typography>
						</Box>
					))}
				</Box>
				<Button
